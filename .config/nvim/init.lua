...
vim.lsp.config("idris2_lsp",  capabilities )
vim.lsp.enable("idris2_lsp")
vim.lsp.config("ocamllsp",  capabilities )
vim.lsp.enable("ocamllsp")
vim.lsp.config("fortls",  capabilities )
vim.lsp.enable("fortls")
vim.lsp.config("julials",  capabilities )
vim.lsp.enable("julials")
vim.lsp.config("agda_ls",  capabilities )
vim.lsp.enable("agda_ls")
vim.lsp.config("quick_lint_js",  capabilities )
vim.lsp.enable("quick_lint_js")
vim.lsp.config("clangd",  capabilities )
vim.lsp.enable("clangd")
vim.lsp.config("perlpls",  capabilities )
